        ...
        <div className="Subhead">
          <div className="StoryNav">
            ...
            <div className="dropdown" style={{display: this.state.isdropdownvisible ? "block" : "none" }}>
              <div style={{ marginTop: "2px" }}><a href="/stories" style={{ color: "black", textDecoration: "none" }}>New Stories</a></div>
              <div style={{ marginTop: "10px" }}><a href="/" style={{ color: "black", textDecoration: "none" }}>Top Stories</a></div>
            </div>
          </div>
